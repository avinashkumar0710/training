...
<div class="container-fluid" style="display: flex; height: 90vh;">
    ...
    <div class="left-section"
        ...
        $sql = "SELECT id, link, title, date, timing, target_group, faculty, open_time, close_time, duration FROM [Complaint].[dbo].[link_tracking] WHERE flag='U' ORDER BY id DESC";
        ...
        <div class="popup-content">
            ...
            <form id="upload-form" action="upload_link.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nature_of_training" id="nature_of_training" required>
                </div>
                <div class="form-group">
