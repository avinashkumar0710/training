        ...
        <div class="height-adjust">
            ...
            if ($hasData) {
                ...
                while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                    ...
                    echo '<td>' . (strlen($row['empno']) == 6 ? '00' . htmlspecialchars($row['empno']) : htmlspecialchars($row['empno'])) . '</td>';
                    ...
                    echo "<td id='attend_count_{$row['id']}'>0</td>";
...
echo '</select>';
                            ...
                            echo '</select>';
                            // Add datepicker input just after attendance dropdown
