...
//             $sql = "SELECT empno, access FROM [Complaint].[dbo].[Training_HR_User] WHERE empno = '$employeeNumber'";
...
//                 echo 'Empno: ' . $row['empno'] . ', Access: ' . $accessLevel . '<br>';
//             }
...
<link rel="icon" type="image/png" sizes="32x32" href="employee.ico">
    ...
    <ul class='nav justify-content-center' style='background-color: #34495E;'>
        ...
        <a class='nav-link' style='color:white' href='Training_TNI.php'>Training Need Identification </a>
