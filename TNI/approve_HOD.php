...
echo 'hello' .$id;
        // Update query
        $sql = "UPDATE [Complaint].[dbo].[request_TNI] set flag = '4', aprroved_time = GETDATE(), appr_empno = '$hodempno' WHERE id = '$id'";
    ...
    echo '<script>alert("Form submitted successfully!"); window.location.href = "TNI_HOD.php";</script>';
} else {
