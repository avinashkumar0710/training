...
<div class="tab-container">
    ...
    <a href="external_training_dashboard.php"><div class="btn btn-outline-primary">External Online Training</div></a>
        <a href="training_validation.php"><div class="btn btn-outline-primary active">Internal Classroom</div></a>
...
$attendance_query = "
    ...
    WHERE flag = '2' and act_Nact_flag = '1'
";
...
<div style="width: 100%;">
    ...
    <?php if ($has_records): ?>
        ...
        <table class="table table-striped table-hover table-bordered border-success" border="2" cellpadding="10" cellspacing="0">
            ...
            <tbody>
                <?php    
                $flag = '2'; // Set the flag value here
                ...
                ?>
                    ...
                    <!-- < href="detailsdepart.php?dept_code=<?php echo urlencode($dept); ?>&dept_details=<?php echo urlencode($dept_details); ?>&flag=<?php echo $flag; ?>" style="text-decoration: none; color: inherit;"> -->
