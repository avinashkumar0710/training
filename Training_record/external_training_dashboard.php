...
<div class="tab-container">
    <div class="tabs">
        ...
        <a href="external_training_dashboard.php"><div class="btn btn-outline-primary active">External Online Training</div></a>
...
$attendance_query = "
    ...
    WHERE flag = '1' and act_Nact_flag = '1' and training_mode='External'
";
