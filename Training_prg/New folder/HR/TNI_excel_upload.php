...
if(isset($_POST["import"])){
    ...
    echo "<script>window.location.href = 'TNI_excel_upload.php';</script>";
}
...
<h6><i class='fa fa-home'></i>&nbsp;<i><u>HR->HR Upload</u></i></h6>
    ...
    <form id="updateForm" action="update_excel_training.php" method="post">
        <table class="table table-bordered border-success" style="height: 100%; border-collapse: collapse;">
            ...
            <tr>
            <td style="display: none; background-color: beige;"><?php echo $row["id"]; ?></td>
