...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['selectedValues'])) {
        ...
        foreach ($selectedValues as $id => $data) {
            ...
            $body .= "The request for nomination for the training programme <strong>$programName</strong> scheduled and has been approved by the Compentent Authority for the following employee.<br>"; // Include program name in bold
