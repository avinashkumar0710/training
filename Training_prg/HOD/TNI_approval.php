...
<head>
    ...
    <title>TNI Subordinate Reporting</title>
...
function displaySelectedData() {
    ...
    checkboxes.forEach(function (checkbox) {
        ...
        var employeeRemarks = row.querySelector('input[name="admin_remarks[]"]').value; // Remarks from Employee
...
<body>
    ...
    <h6><i class="fa fa-home"></i>&nbsp;<i><u>Training Nomination for Subordinate</u></i></h6>
    <div class="full-width">
        <div class="row">
            <div class="col-md-6">
                ...
                <select name="employeeSelect" id="employeeSelect" onchange="showEmployeeDetails()">
                    ...
                    $query = "SELECT empno, name, grade, employee_grp, location FROM [Complaint].[dbo].[emp_mas_sap] WHERE rep_ofcr = ? AND status = 'A'";
            ...
            <div id="selectedDataDisplay" style="display:none;">
                ...
                ?>
                <br>
                <form method="POST" action="target_page_request.php" id="dataForm">
        ...
        $fetch_program_name = "SELECT DISTINCT program_name, srl_no FROM [Complaint].[dbo].[request] WHERE appr_empno = '$sessionemp' and flag='2'";
...
$(document).ready(function() {
    $("#programForm1").submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "fetch_subordinate_repofcr.php", // Ensure this file processes the request correctly
